...
Converter.convert = function(baseURL, conf,options) {
  ...
  resources.forEach(function(res) {    
    var schema = definitions[res.type] = getSchema(res,options.schemaPath);
  ...
  definitions=Object.assign(definitions, defaultSchemes.components.schemas)
  return swagger;
}
